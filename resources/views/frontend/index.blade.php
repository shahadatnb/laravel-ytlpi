            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="pogoSlider" id="js-main-slider">
                     <div class="pogoSlider-slide" style="background-image:url({{url('/public/fontend')}}/images/slider_1.jpg);">
                        <div class="container">
                           <div class="row">
                              <div class="col-md-12">
               ...
               <div class="row">
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                     <div class="full feature_box">
                         <div class="full icon">
                            <img class="default-block" src="{{url('/public/fontend')}}/images/icon_1.png" alt="#" />
                            <img class="default-none" src="{{url('/public/fontend')}}/images/icon_1w.png" alt="#" />
                         </div>
                         <div class="full">
                            <h4>Link Building</h4>
                         </div>
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                     <div class="full feature_box">
                         <div class="full icon">
                            <img class="default-block" src="{{url('/public/fontend')}}/images/icon_2.png" alt="#" />
                            <img class="default-none" src="{{url('/public/fontend')}}/images/icon_2w.png" alt="#" />
                         </div>
                         <div class="full">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                     <div class="full feature_box">
                         <div class="full icon">
                            <img class="default-block" src="{{url('/public/fontend')}}/images/icon_3.png" alt="#" />
                            <img class="default-none" src="{{url('/public/fontend')}}/images/icon_3w.png" alt="#" />
                         </div>
                         <div class="full">
                            <h4>On Page SEO</h4>
                         </div>
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                     <div class="full feature_box">
                         <div class="full icon">
                            <img class="default-block" src="{{url('/public/fontend')}}/images/icon_4.png" alt="#" />
                            <img class="default-none" src="{{url('/public/fontend')}}/images/icon_4w.png" alt="#" />
                         </div>
                         <div class="full">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                     <div class="full text_align_center">
                        <img class="img-responsive" src="{{url('/public/fontend')}}/images/f1.png" alt="#" />   
                      </div>
                  </div>
               </div>
            </div>
         ...
         <div class="section about_section layout_padding padding_top_0">
            <div class="container">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="full text_align_center">
                       <img class="img-responsive" src="{{url('/public/fontend')}}/images/video_img.jpg" alt="#" />
                     </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                   <div class="work_blog margin-top_30">
                      <img class="img-responsive" src="{{url('/public/fontend')}}/images/blog1.jpg" alt="#" />
                      <div class="hover_workblog">
                          <img src="{{url('/public/fontend')}}/images/search_icon.png" alt="#" />
                      </div>
                   </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                   <div class="work_blog margin-top_30">
                      <img class="img-responsive" src="{{url('/public/fontend')}}/images/blog2.jpg" alt="#" />
                      <div class="hover_workblog">
                          <img src="{{url('/public/fontend')}}/images/search_icon.png" alt="#" />
                      </div>
                   </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                   <div class="work_blog margin-top_30">
                      <img class="img-responsive" src="{{url('/public/fontend')}}/images/blog3.jpg" alt="#" />
                      <div class="hover_workblog">
                          <img src="{{url('/public/fontend')}}/images/search_icon.png" alt="#" />
                      </div>
                   </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                   <div class="work_blog margin-top_30">
                      <img class="img-responsive" src="{{url('/public/fontend')}}/images/blog4.jpg" alt="#" />
                      <div class="hover_workblog">
                          <img src="{{url('/public/fontend')}}/images/search_icon.png" alt="#" />
                      </div>
                   </div>
